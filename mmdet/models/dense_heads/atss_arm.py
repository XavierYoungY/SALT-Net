...
from mmdet.core import (anchor_inside_flags, build_assigner, build_sampler,
                        ...
                        distance2bbox, reduce_mean, unmap)
...
class NFHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(NFHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, centerness,
                    bbox_distance, labels, label_weights, bbox_targets, stride,
                    num_total_samples):
        ...
        if len(pos_inds) > 0:
            ...
            pos_bbox_distance = bbox_distance[pos_inds]
            ...
            pos_reg_init_bbox = distance2bbox(pos_anchor_centers,
                                              pos_bbox_distance)
            ...
            loss_bbox_init = self.loss_bbox_init(
                pos_reg_init_bbox,
                pos_decode_bbox_targets / stride[0],
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, loss_centerness,\
            bbox_avg_factor, losses_bbox_init = multi_apply(
                self.loss_single,
                anchor_list,
                cls_scores,
                bbox_preds,
        ...
        losses_bbox_init = list(
            map(lambda x: x / bbox_avg_factor, losses_bbox_init))
        return dict(
            loss_cls=losses_cls,
